...
# ____________________________________Function which control of operating conditions____________________________________
...
def model_predictive_control(t, solver_variables, operating_inputs, parameters, control_variables):
    """
